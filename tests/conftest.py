...
# WARNING: Ensure imports from `alpacas_api` comes after this line
from alpacas_api import app, settings, db  # noqa
from alpacas_api.cli import create_user, cli  # noqa
